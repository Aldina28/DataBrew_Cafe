...
//    private AnchorPane dashboard_form;
    ...
    public void dashboardTotalI(){
        ...
        try{
            ...
            dashboard_totalI.setText("Rs "+ti);
    ...
    public void inventoryUpdateBtn(){
        if(inventory_productID.getText().isEmpty() ||
            ...
            String updateData = "UPDATE product SET " + "prod_id = '"+
                    inventory_productID.getText() + "', type = '"+
            ...
            try{
                ...
                alert.setHeaderText(null);
                alert.setContentText("Are you sure you want to update: " + inventory_productID.getText() +"?");
    ...
    private String[] typeList = {"Meal", "Drinks"};
...
//To get id per order
   ...
   public void menuRemoveBtn(){
    ...
    public void menuRestart(){
        ...
        change = 0;
        amount = 0;
        menu_total.setText("Rs 0");
        menu_amount.setText("");
        menu_change.setText("Rs 0");
    }
    private int cID;
